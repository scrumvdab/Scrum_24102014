...
<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<div class="clearfix">
			...
			<a href="{{ URL::route('forum-get-new-thread', $category->id) }}" class="btn btn-success btn-xs pull-right">Nieuwe thread</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="" type="button" class="btn btn-primary" id="btn_delete_category">Verwijderen</a>
			</div>
		</div>
	</div>
</div>
